...
| First-party terrain tools | implemented-unverified | Command-backed overlay, vertex-aware raise/lower with radius/falloff, tile-flag, flatten, and neighbour-aware smoothing brushes are tested; ramp/sampling and legacy UI wiring remain |
