...
| OSRS coordinate and tile inspector contract | implemented-unverified | `WorldWindow`, `WorldTileAddress`, and `TileInspectorSnapshot` provide validated world/region/chunk breakdowns and raw flag semantics; the controlled inspector now also exposes neutral movement/projectile collision snapshots, while live hover wiring remains |
