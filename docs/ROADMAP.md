...
writer. The next required cache decision is either a safe OpenRune-compatible
writer or a formally documented OpenRune-read/Displee-output arrangement. Run
