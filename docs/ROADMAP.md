...
| First-party object tools | implemented-unverified | Place/delete/rotate plus pick-on-drag move and duplicate tools invoke canonical commands; shared nearest-grid snapping is now available, while multi-select and replace remain |
