...
| Foundation resource review | verified | The 2026-09-17 cross-resource audit confirms OpenRune FileStore as the only production ecosystem dependency, RSPSi as the owner of canonical world/editor semantics, RuneLite as the independent OSRS oracle, TSPS as scene/edit-mode donor, OpenRune-Editor as workflow donor, and Domw71 as a RuneLite-derived revision-240 integration case study; no second cache/world/history system is approved |
