...
| First-party object tools | implemented-unverified | Place/delete/rotate plus pick-on-drag move and duplicate tools invoke canonical commands; shared nearest-grid snapping and neutral box object selection are now available, while multi-object transforms and replace remain |
