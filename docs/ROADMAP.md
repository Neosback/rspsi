...
| First-party object commands | implemented-unverified | Place/delete/move/rotate plus atomic multi-object moves and rotations are tested through `EditorSession`; richer transform coverage remains |
| First-party object tools | implemented-unverified | Place/delete/rotate plus pick-on-drag move, duplicate, box object selection, move-selection, and rotate-selection tools invoke canonical commands; multi-object duplicate and replace remain |
