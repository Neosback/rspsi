...
public final class CollisionFlag {
    ...
    public static final int BLOCK_NORTH_AND_SOUTH_EAST = WALL_NORTH | WALL_NORTH_EAST
            | WALL_EAST | WALL_SOUTH_EAST | WALL_SOUTH | LOC | FLOOR_BLOCKED;
    public static final int BLOCK_NORTH_AND_SOUTH_WEST = WALL_NORTH_WEST | WALL_NORTH
            | WALL_SOUTH | WALL_SOUTH_WEST | WALL_WEST | LOC | FLOOR_BLOCKED;
    public static final int BLOCK_NORTH_EAST_AND_WEST = WALL_NORTH_WEST | WALL_NORTH
            | WALL_NORTH_EAST | WALL_EAST | WALL_WEST | LOC | FLOOR_BLOCKED;
    public static final int BLOCK_SOUTH_EAST_AND_WEST = WALL_EAST | WALL_SOUTH_EAST
            | WALL_SOUTH | WALL_SOUTH_WEST | WALL_WEST | LOC | FLOOR_BLOCKED;
    ...
    public static final int BLOCK_NORTH_AND_SOUTH_EAST_ROUTE_BLOCKER = WALL_NORTH_ROUTE_BLOCKER
            | WALL_NORTH_EAST_ROUTE_BLOCKER | WALL_EAST_ROUTE_BLOCKER | WALL_SOUTH_EAST_ROUTE_BLOCKER
            | WALL_SOUTH_ROUTE_BLOCKER | LOC_ROUTE_BLOCKER | FLOOR_BLOCKED;
    public static final int BLOCK_NORTH_AND_SOUTH_WEST_ROUTE_BLOCKER = WALL_NORTH_WEST_ROUTE_BLOCKER
            | WALL_NORTH_ROUTE_BLOCKER | WALL_SOUTH_ROUTE_BLOCKER | WALL_SOUTH_WEST_ROUTE_BLOCKER
            | WALL_WEST_ROUTE_BLOCKER | LOC_ROUTE_BLOCKER | FLOOR_BLOCKED;
    public static final int BLOCK_NORTH_EAST_AND_WEST_ROUTE_BLOCKER = WALL_NORTH_WEST_ROUTE_BLOCKER
            | WALL_NORTH_ROUTE_BLOCKER | WALL_NORTH_EAST_ROUTE_BLOCKER | WALL_EAST_ROUTE_BLOCKER
            | WALL_WEST_ROUTE_BLOCKER | LOC_ROUTE_BLOCKER | FLOOR_BLOCKED;
    public static final int BLOCK_SOUTH_EAST_AND_WEST_ROUTE_BLOCKER = WALL_EAST_ROUTE_BLOCKER
            | WALL_SOUTH_EAST_ROUTE_BLOCKER | WALL_SOUTH_ROUTE_BLOCKER | WALL_SOUTH_WEST_ROUTE_BLOCKER
            | WALL_WEST_ROUTE_BLOCKER | LOC_ROUTE_BLOCKER | FLOOR_BLOCKED;
}
