...
class MapIndexLoaderOSRSTest {
    ...
    void loadsNamedArchivesAndExposesLegacyCompatibilityLookups() {
        ...
        MapIndexLoaderOSRS loader = new MapIndexLoaderOSRS();
    ...
    void compatibilityEncodingCanBeDecodedWithoutCacheTypes() {
        MapIndexLoaderOSRS original = new MapIndexLoaderOSRS();
        original.set(10, 20, 300, 301);
        original.set(10, 21, 302, 303);

        MapIndexLoaderOSRS decoded = new MapIndexLoaderOSRS();
